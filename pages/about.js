    ...
    <InfoStyled>
      ...
      <InfoBody>
        ...
        <p>
          ...
          jednakże <span>muzyka rockowa oraz metalowa </span> to główne obiekty
          naszych zainteresować. Disco Polo tutaj nie uświadczycie...chyba.
        </p>
        <p>
        ...
        <p>
          ...
          - zarówno muzyków jak i organizatorów imprez. Może i nie mamy pleców u
          gigantów w przemyśle muzycznym, ale{' '}
          <span>
